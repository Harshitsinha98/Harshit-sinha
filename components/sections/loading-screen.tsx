...
import { NameLoader } from "@/components/sections/NameLoader";

// NOTE: this component is rendered only by app/page.tsx (the homepage),
// gated behind its own `loading` state. It is intentionally NOT a Next.js
// `app/loading.tsx` file — that special filename fires on every route
// transition (including /contact, /projects, etc.), which is why the intro
// used to replay on every page instead of just the first visit.
